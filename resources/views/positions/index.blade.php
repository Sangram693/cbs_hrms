        ...
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-gray-50">
                    <td class="py-3 px-6 text-center whitespace-nowrap">{{ $position->title }}({{ $position->level }})</td>
                    @if(auth()->user()->isSuperAdmin())
                    <td class="py-3 px-6 text-center whitespace-nowrap">{{ $position->company->name ?? '-' }}</td>
                    @endif
                    <td class="py-3 px-6 text-center whitespace-nowrap">{{ $position->department->name ?? '-' }}</td>
                ...
                <tr class="bg-white border-b">
                    <td colspan="4" class="py-3 px-6 text-center">No positions found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>

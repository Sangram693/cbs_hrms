...
<div class="max-w-6xl mx-auto mt-4">
    ...
    <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-2xl shadow-lg border border-blue-200 mt-4">
        <div id="dashboard-stats" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-3" role="region" aria-label="Dashboard Statistics">
            ...
            @endforeach
            <a href="{{ route('profile.edit') }}" class="group block bg-white border border-gray-300 rounded-xl p-3 shadow hover:shadow-xl transition flex flex-col items-center text-center hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500" role="link" aria-label="Profile">

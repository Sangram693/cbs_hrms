...
<div class="bg-white p-6 rounded shadow max-w-lg mx-auto">
    ...
    <form action="{{ route('leavetypes.store', auth()->user()->isSuperAdmin() ? ['company_id'=>request('company_id')] : []) }}" method="POST" id="leaveTypeForm">
        @csrf
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="{{ route('leavetypes.index', $user->isSuperAdmin() ? ['company_id'=>old('company_id', request('company_id'))] : []) }}" 

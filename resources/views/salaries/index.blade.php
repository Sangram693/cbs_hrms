...
@section('content')
<div class="bg-white p-6 rounded shadow max-w-7xl mx-auto">    <h2 class="text-xl font-bold mb-4">Salaries</h2>
        ...
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    @endif                    <td class="py-3 px-6 text-center whitespace-nowrap">
                        @if(auth()->user()->isSuperAdmin() || auth()->user()->isAdmin() || auth()->user()->isHr())
                            ...
                            <form action="{{ route('salaries.destroy', $salary->id) }}" method="POST" class="inline" style="display:inline">
                                @csrf
                            @method('DELETE')                                <button type="submit" class="text-red-600 hover:text-red-800 bg-transparent border-none p-0 m-0 cursor-pointer" title="Delete">

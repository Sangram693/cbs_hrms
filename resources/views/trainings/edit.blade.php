...
<div class="bg-white p-6 rounded shadow max-w-lg mx-auto">
    <h2 class="text-xl font-bold mb-4">Edit Training</h2>    <form action="{{ route('trainings.update', $training) }}" method="POST" id="trainingForm" onsubmit="return validateForm(event)">
        @csrf
        @method('PUT')
        <div class="mb-4">
            @php
        ...
        <div class="mb-4 date-field" id="startDateField">
            <label class="block mb-1">
                ...
                <span class="text-sm text-gray-500 ml-1" id="startDateRequired"></span>
            </label>
        ...
        <div class="mb-4 date-field" id="endDateField">
            <label class="block mb-1">
                ...
                <span class="text-sm text-gray-500 ml-1" id="endDateRequired"></span>
            </label>
